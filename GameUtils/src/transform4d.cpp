...
{
	n[0][0] = n00; n[0][1] = n10; n[0][2] = n20; n[0][3] = 0.F;
	n[1][0] = n01; n[1][1] = n11; n[1][2] = n21; n[1][3] = 0.F;
	n[2][0] = n02; n[2][1] = n12; n[2][2] = n22; n[2][3] = 0.F;
	n[3][0] = n03; n[3][1] = n13; n[3][2] = n23; n[3][3] = 1.F;
...
{
	n[0][0] = a.x; n[0][1] = a.y; n[0][2] = a.z; n[0][3] = 0.F;
	n[1][0] = b.x; n[1][1] = b.y; n[1][2] = b.z; n[1][3] = 0.F;
	n[2][0] = c.x; n[2][1] = c.y; n[2][2] = c.z; n[2][3] = 0.F;
	n[3][0] = p.x; n[3][1] = p.y; n[3][2] = p.z; n[3][3] = 1.F;
}
