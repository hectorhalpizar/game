...
GLboolean WinCreate2 ( ESContext *esContext, const char *title, const int icon )
{
   ...
   SendMessageW(esContext->hWnd, WM_SETICON, ICON_BIG, (LPARAM)LoadIcon(hInstance, MAKEINTRESOURCE(icon)));
   SendMessageW(esContext->hWnd, WM_SETICON, ICON_SMALL, (LPARAM)LoadIcon(hInstance, MAKEINTRESOURCE(icon)));
